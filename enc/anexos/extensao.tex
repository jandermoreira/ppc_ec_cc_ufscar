...
Para a contabilização das ACEs, ficam estabelecidos os limites para cada possível atividade:
...
%\begin{itemize}
%\item Projeto e$\backslash$ou implementação real (hardware e$\backslash$ou software);
